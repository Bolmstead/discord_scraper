...
const coins = {
  ...
  TGC: {
    ...
    address: "2r14PUPidY1ZGPvDRVSQCZMYW8R8t8WtqdbCXFsLpump",
...
const accountMap = new Map([
  ...
  [
    "elonmusk",
    {
      ...
      coins: [
        ...
        { ...coins.TRUMP2028, amountToBuy: 10 },
        { ...coins.SWF, amountToBuy: 10 },
        { ...coins.DOGEFATHER, amountToBuy: 70 },
        { ...coins.SBR, amountToBuy: 70 },
  ...
  [
    "JDVance",
    {
      ...
      priorityFeeForAnyPostedCA: 0.1,
      coins: [
        { ...coins.PWEASE, amountToBuy: 70, dontSell: true },
        { ...coins.TITCOIN, amountToBuy: 70 },
        { ...coins.BUTTCOIN, amountToBuy: 70 },
        { ...coins.DICKBUTT, amountToBuy: 70 },
        { ...coins.FARTCOIN, amountToBuy: 70 },
        { ...coins.HARAMBE, amountToBuy: 70 },
        { ...coins.DOGWIFHAT, amountToBuy: 70 },
        { ...coins.FLOKI, amountToBuy: 10 },
  ...
  [
    "DavidSacks",
    {
      name: "David Sacks",
      coins: [
        { ...coins.SWF, amountToBuy: 10, dontSell: true },
        { ...coins.SBR, amountToBuy: 70 },
      ],
    },
  ],

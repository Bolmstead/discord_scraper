...
const coins = {
  ...
  ROARINGKITTY2: {
    name: "Roaring Kitty 2",
    address: "EKEWAk7hfnwfR8DBb1cTayPPambqyC7pwNiYkaYQKQHp",
    keywords: ["roaring kitty 2", "roaringkitty 2", "keith gill 2"],
  },
  BASEDELON: {
    name: "Based Elon",
...
const accountMap = new Map([
  ...
  [
    "realDonaldTrump",
    {
      name: "Donald Trump",
      coins: [
        { ...coins.FARTCOIN, amountToBuy: 10 },
        { ...coins.PENGU, amountToBuy: 10 },
        { ...coins.MOODENG, amountToBuy: 10 },
        { ...coins.GOATSEUSMAXIMUS, amountToBuy: 10 },
        { ...coins.SHARKCAT, amountToBuy: 10 },
        { ...coins.PONKE, amountToBuy: 10 },
        { ...coins.MICHI, amountToBuy: 10 },
        // TRUMP
        { ...coins.CHILLGUY, amountToBuy: 10 },
        { ...coins.ZEREBRO, amountToBuy: 10 },
        { ...coins.UNICORNFARTDUST, amountToBuy: 10 },
        { ...coins.RETARDIO, amountToBuy: 10 },
        { ...coins.FWOG, amountToBuy: 10 },
        { ...coins.HOSICO, amountToBuy: 10 },
        { ...coins.BOOKOFMEME, amountToBuy: 10 },
        { ...coins.PWEASE, amountToBuy: 10 },
        { ...coins.USELESSCOIN, amountToBuy: 10 },
        { ...coins.BRAINLET, amountToBuy: 10 },
        { ...coins.BUTTHOLE, amountToBuy: 10 },
        // TRUMP
        { ...coins.CHILLHOUSE, amountToBuy: 10 },
        { ...coins.AI16Z, amountToBuy: 10 },
        { ...coins.DOGWIFHAT, amountToBuy: 10 },
        { ...coins.GIGACHAD, amountToBuy: 10 },
        { ...coins.POPCAT, amountToBuy: 10 },
        { ...coins.RETARDFINDER, amountToBuy: 10 },
        { ...coins.HOSICO, amountToBuy: 10 },
        { ...coins.SARATOGA, amountToBuy: 5 },
        ...
        // TRUMP
        { ...coins.SIGMABOY, amountToBuy: 6 },
        { ...coins.THEAMERICAPARTY, amountToBuy: 10 },
        { ...coins.DEPORTLON, amountToBuy: 3 },
        { ...coins.CSR, amountToBuy: 10 },
        { ...coins.ROARINGKITTY, amountToBuy: 10 },
        ...
        { ...coins.PNUT, amountToBuy: 10 },
        { ...coins.BIGBALLS, amountToBuy: 10 },
        // TRUMP
        { ...coins.DOGEFATHER, amountToBuy: 10 },
        { ...coins.LUIGI, amountToBuy: 10 },
        { ...coins.HARAMBE, amountToBuy: 10 },
        { ...coins.JAILSTOOL, amountToBuy: 10 },
        { ...coins.DOODOOCOIN, amountToBuy: 4 },
        { ...coins.GROKCOIN, amountToBuy: 10 },
        { ...coins.DICKBUTT, amountToBuy: 15 },
        { ...coins.TITCOIN, amountToBuy: 10 },
        { ...coins.BUTTCOIN, amountToBuy: 10 },
        { ...coins.SBR, amountToBuy: 10 },
        { ...coins.TRUMP2028, amountToBuy: 5 },
        { ...coins.TRUTHGPT, amountToBuy: 2 },
        { ...coins.KNOX, amountToBuy: 5 },
        // TRUMP
  ...
  [
    "elonmusk",
    {
      ...
      coins: [
        ...
        { ...coins.THEAMERICAPARTY2, amountToBuy: 10 },
        { ...coins.DICKIPEDIA, amountToBuy: 3 },
        { ...coins.OPTIMUSCOMPANION, amountToBuy: 5 },
        { ...coins.KAICOMPANION, amountToBuy: 5 },
        { ...coins.PENGU, amountToBuy: 10 },
        {
          ...coins.BASEDELON,
          amountToBuy: 10,
        ...
        { ...coins.HOSICO, amountToBuy: 10 },
        { ...coins.BOOKOFMEME, amountToBuy: 10 },
        { ...coins.LAUNCHCOIN, amountToBuy: 10 },
        { ...coins.USELESSCOIN, amountToBuy: 10 },
        { ...coins.BRAINLET, amountToBuy: 10 },
        { ...coins.BUTTHOLE, amountToBuy: 10 },
        { ...coins.CHILLHOUSE, amountToBuy: 10 },
        ...
        // ELON
        { ...coins.BUTTCOIN, amountToBuy: 10 },
        { ...coins.GORBAGANA, amountToBuy: 10 },
        { ...coins.OBIPNUTKENOBI, amountToBuy: 10 },
        { ...coins.JAILSTOOL, amountToBuy: 10 },
        { ...coins.PWEASE, amountToBuy: 10 },
        { ...coins.ROARINGKITTY, amountToBuy: 10 },
        { ...coins._8008, amountToBuy: 6 },
        // ELON
        { ...coins.DOODOOCOIN, amountToBuy: 4 },
        { ...coins.GROKCOIN, amountToBuy: 10 },
  ...
  [
    "RoaringKitty",
    {
      ...
      coins: [{ ...coins.ROARINGKITTY, amountToBuy: 10 }],
      automaticallyBuyThisCoin: { ...coins.ROARINGKITTY, amountToBuy: 10 },
    },
  ],
]);

...
const accountMap = new Map([
  ...
  [
    "elonmusk",
    {
      ...
      coins: [
        ...
        { ...coins.FREESHLOMO, amountToBuy: 5 },
  ...
  [
    "WatcherGuru",
    {
      ...
      coins: [
        ...
        { ...coins.TRUMPSEASON, amountToBuy: 5 },
        { ...coins.TRUMPBILL, amountToBuy: 4 },
        { ...coins.STRATEGICSOLANARESERVE, amountToBuy: 15 },
      ],
      buyAnyPostedCA: true,
      amountToBuyForAnyPostedCA: 8,
      slippageBpsForAnyPostedCA: 5000,
  ...
  [
    ...
    {
      name: "toly🇺🇸",
      coins: [{ ...coins.STRATEGICSOLANARESERVE, amountToBuy: 10 }],
      buyAnyPostedCA: true,
      amountToBuyForAnyPostedCA: 8,
      slippageBpsForAnyPostedCA: 5000,
      timeToSellForAnyPostedCA: 120 * 1000,
  ...
  [
    ...
    {
      name: "CZ",
      coins: [{ ...coins.BROC, amountToBuy: 20 }],
      buyAnyPostedCA: true,
      amountToBuyForAnyPostedCA: 8,
      slippageBpsForAnyPostedCA: 5000,
      timeToSellForAnyPostedCA: 120 * 1000,
  ...
  [
    "kanyewest",
    {
      name: "Kanye West",
      coins: [
        { ...coins.SWASTI, amountToBuy: 2 },
        { ...coins.SWASTA, amountToBuy: 2 },
      ],
      buyAnyPostedCA: true,
      amountToBuyForAnyPostedCA: 8,
      slippageBpsForAnyPostedCA: 5000,
